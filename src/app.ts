...
// ★秒飛び対策★ 1秒間隔だと、盤面描画などでメインスレッドが一瞬塞がって
// setInterval が遅延したとき（例: 17→15, 2→0 と飛ぶ）が起きる。締め切りは
// 絶対時刻で正しいので、更新頻度を上げて（250ms）どの秒境界にも素早く追従させ、
// 見た目を1秒ずつにする。1回描画はテキスト更新数個ぶんで軽い。
setInterval(() => {
